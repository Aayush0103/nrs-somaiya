...
function animationPipeline() {
    ...
    startAnimation = new TimelineMax({ repeat: 0 }),
        ...
        questions = [
            ...
            'Which is the largest number in 15/17, 15/18, 15/19, 15/21?',
            'How many digits answer we will get when we add 99 and 1?',
            'Name a triangle whose two angles are equal.'
        ],
        answers = [
            ['71', '109', '89', 'None of these'],
            ['3', '1', '7', 'None of these'],
            ['700', '666', '10', '100'],
            ['0', '32', '56', '46'],
            ['216', '7230', '106', '372'],
            ['25', '6', '28', '7'],
            ['96', '97', '98', '99'],
            ['15/18', '15/19', '15/17', '15/21'],
            ['1', '99', '100', '3'],
            ['Right angle triangle.', 'Scalene triangle.', 'Isosceles triangle.', 'None of these.']
        ],
        correctAnswers = [0, 1, 1, 3, 0, 0, 1, 2, 3, 2],
        gameAnswers = [];
